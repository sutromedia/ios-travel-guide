...
@interface ASICloudFilesObjectRequest : ASICloudFilesRequest <NSXMLParserDelegate> {
	...
	NSString *__unsafe_unretained accountName;
	NSString *__unsafe_unretained containerName;
	
	// Internally used while parsing the response
	NSString *__unsafe_unretained currentContent;
	NSString *__unsafe_unretained currentElement;
	ASICloudFilesObject *__unsafe_unretained currentObject;
	NSMutableArray *objects;
	
}

@property  (unsafe_unretained) NSString *accountName;
@property  (unsafe_unretained) NSString *containerName;
@property  (unsafe_unretained) NSString *currentElement;
@property  (unsafe_unretained) NSString *currentContent;
@property  (unsafe_unretained) ASICloudFilesObject *currentObject;
