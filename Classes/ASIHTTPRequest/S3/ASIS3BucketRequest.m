...
@property ( unsafe_unretained, unsafe_unretained, nonatomic) ASIS3BucketObject *currentObject;
@property  (unsafe_unretained) NSMutableArray *objects;
@property  (unsafe_unretained) NSMutableArray *commonPrefixes;
