...
@interface ASIS3ObjectRequest : ASIS3Request {
	...
	NSString *__unsafe_unretained sourceBucket;
	NSString *__unsafe_unretained sourceKey;
	...
	NSString *__unsafe_unretained mimeType;
	...
	NSString *__unsafe_unretained storageClass;
}
...
@property ( unsafe_unretained, nonatomic) NSString *sourceBucket;
@property ( unsafe_unretained, nonatomic) NSString *sourceKey;
@property ( unsafe_unretained, nonatomic) NSString *mimeType;
@property ( unsafe_unretained, nonatomic) NSString *subResource;
@property ( unsafe_unretained, nonatomic) NSString *storageClass;
@end
