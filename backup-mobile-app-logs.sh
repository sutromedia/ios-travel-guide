...
if [ -r ${CONFIGFILE} ]; then
	...
	USERNAME="stats_readonly"
	
	# Password to access the MySQL server e.g. password
	PASSWORD="plym0uth"
	
	# Host name (or IP address) of MySQL server e.g localhost
	DBHOST="mysql.motientmedia.com"
	
	# List of DBNAMES for Daily/Weekly Backup e.g. "DB1 DB2 DB3"
	DBNAMES="sutro_mobile_app_logs"
...
RM="`${WHICH} rm`"
MYSQL="`${WHICH} mysql`"
# commented by kevin on 3/22/2011 MYSQLDUMP="`${WHICH} mysqldump5`"
